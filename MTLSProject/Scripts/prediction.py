...
#predictedtopology = predictionmodules.predicting("finalizedmodel.pkl",testinginput,dictionary2)
predictedtopology = predictionmodules.predicting("PSSMmodel.pkl",testinginput,dictionary2)
